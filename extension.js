...
function enable() {
    ...
    if (frontPanelExists) {
        ...
        volumeMenu.addMenuItem(volumeMenu._frontPanelSwitch, 1);

        // update switch status when volume menu opened
        volumeMenu.connect('open-state-changed', function () {
        ...
        volumeMenu.addMenuItem(volumeMenu._noFrontPanelItem, 1);
    }
}
